...
describe TaskMailer, type: :mailer do
  ...
  let(:task) { FactoryBot.create(:task, name: "メイラーSpecを書く", description: "送信したメールの内容を確認します", due_date: "2100-10-10", priority: 3, user: user_a) }
  ...
  describe "#creation_email" do
    ...
    it "想定どおりのメールが生成されている" do
      ...
      expect(text_body).to match("2100-10-10")
